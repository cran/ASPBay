...
RcppExport SEXP ASPBay_MHcpp(SEXP NSEXP, SEXP thinSEXP, SEXP SSEXP, SEXP RSEXP, SEXP sd_freqSEXP, SEXP sd_psiSEXP, SEXP p0SEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        arma::mat __result = MHcpp(N, thin, S, R, sd_freq, sd_psi, p0);
